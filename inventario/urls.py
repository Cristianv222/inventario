...
urlpatterns = [
    ...
    # ========== APIs LEGACY (DIFERENTES URLs) ==========
    path('api/buscar-producto/', views.buscar_producto_api, name='buscar_producto_api'),
    path('api/escanear-imagen/', views.escanear_imagen, name='escanear_imagen'),
    path('api/buscar-productos-etiquetas-legacy/', views.buscar_productos_etiquetas, name='buscar_productos_etiquetas'),
    ...
    path('productos/exportar/', views.exportar_productos_csv, name='exportar_productos'),
